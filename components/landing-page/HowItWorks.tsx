      ...
      steps: [
        {
          ...
          text: (
            <p>
              When working with local markdown or MDX files, you tell Contentlayer the expected shape of your data (document
              type definitions).
            </p>
          ),
          cta: {
        ...
        },
        {
          ...
          text: (
            <>
              <p className="mb-4">
                Run Contentlayer to process your content. Do this as part of the Next.js dev server, or using the Contentlayer
                CLI.
              </p>
              <p>
                This validates the content, then generates types definitions and outputs data objects ready to be imported as a
                ESM module.
              </p>
            </>
          ),
        ...
        },
        {
          ...
          text: (
            <>
              <p className="mb-4">
                Import the data just like you would any other JavaScript library. Use it to render pages, and pass down as props
                to the components on those pages.
              </p>
              <p>
      ...
      steps: [
        {
          ...
          text: (
            <p>
              Tell Contentlayer how to filter database content, which properties to include, and add any additional computed
              properties.
            </p>
          ),
          cta: {
        ...
        },
        {
          ...
          text: (
            <>
              <p className="mb-4">
                Run Contentlayer to process your content. Do this as part of the framework server, or using the Contentlayer
                CLI.
              </p>
              <p>
                This validates the content from notion, then generates types definitions and outputs data objects ready to be
  ...
  <div className="w-full max-w-screen-xl px-4 mx-auto mt-16 md:mt-24 md:px-8 lg:mt-32">
    <Tabs.Root defaultValue={content.tabs[0].title.toLowerCase().replace(/ /g, '-')}>
      <div className="space-y-8 sm:text-center">
        ...
        <Tabs.List aria-label="Select content source" className="flex flex-nowrap overflow-x-auto py-0.5 sm:justify-center">
      ...
      {content.tabs
        ...
        .map(({ title, steps }, index) => (
          <Tabs.Content key={index} value={title.toLowerCase().replace(/ /g, '-')} className="relative focus:outline-none">
